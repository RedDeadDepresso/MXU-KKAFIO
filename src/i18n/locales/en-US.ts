export default {
  ...
  contextMenu: {
    ...
    renameTab: 'Rename',
    useInExplorerMenu: 'Use in Explorer Context Menu',
    removeFromExplorerMenu: 'Remove from Explorer Context Menu',
    explorerMenuBadge: 'Used by the Explorer right-click menu',
    moveLeft: 'Move Left',
